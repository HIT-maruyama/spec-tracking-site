...
推奨: **90 days**（90日間）
- セキュリティのため、定期的な更新を推奨
- 必要に応じて **No expiration**（無期限）も選択可能
...
**注意**: 必要最小限の権限のみを付与することをお勧めします。

![Select Scopes](https://docs.github.com/assets/cb-43299/mw-1440/images/help/settings/token-scopes.webp)
